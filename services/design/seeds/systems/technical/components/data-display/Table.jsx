/* TeleDesign seed system "Technical" — Table.
...
(() => {
  ...
  function Table({ columns = [], rows = [], density = "compact", striped = false, caption, className = "" }) {
    const d = DENSITIES.includes(density) ? density : "compact";
