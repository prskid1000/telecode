...
def register_default_tasks():
    ...
    _agent_task_schema = {
        ...
        "properties": {
            ...
            "model": {"type": "string", "description": "Optional model: engine model id in cloud mode (e.g. a Claude alias), llama model name in local mode. Blank = CLI default / loaded model."},
